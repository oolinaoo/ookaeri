...
(function ($) {
	...
	$.fn.extend({
		monthly: function (customOptions) {
			...
			$(parent).prepend('<div class="monthly-header"><div class="monthly-header-title"><a href="#" class="monthly-header-title-date" onclick="return false"></a></div><a href="#" class="monthly-prev"></a><a href="#" class="monthly-next"></a></div>');
			...
			function setMonthly(month, year) {
				...
				for (var dayNumber = 1; dayNumber <= dayQty; dayNumber++) {
					...
					if (options.mode === "event") {
						var thisDate = new Date(year, mZeroed, dayNumber+1, 0, 0, 0, 0);
