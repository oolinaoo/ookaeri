...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function(e) {
    ...
    var pop = '<div id="lightboxOverlay" tabindex="-1" class="lightboxOverlay"></div>' +
              '<div id="lightbox" tabindex="-1" class="lightbox">' +
                '<div class="lb-outerContainer">' +
                  '<div class="lb-container">' +
                    ...
                    '</div>' +
                    '<div>' +
                      '<button class="lb-reserve" type="button">預約</button>' +
                    '</div>' +
                  '</div>' +
                '</div>' +
